...
/*
  vector[N] lin_pred = beta_age[age] + [beta_sex, -beta_sex][sex]' + beta_edu[edu] + beta_eth[eth] + beta_lan[lan] + beta_rel[rel] + beta_emp[emp] + beta_reg[reg]
                       ...
                       + [beta_buk,-beta_buk][buk]' + [beta_mig,-beta_mig][mig]' + [beta_hhlan,-beta_hhlan][hhlan]';
*/                       
  vector[N] lin_pred = beta_age[age] + [beta_sex, -beta_sex][sex]' + beta_edu[edu] + beta_eth[eth] + beta_lan[lan] + beta_rel[rel] + beta_emp[emp] + beta_reg[reg]
...
{
/*
vector[N_pred] lin_pred = beta_age[age_pred] + [beta_sex, -beta_sex][sex_pred]' + beta_edu[edu_pred] + beta_eth[eth_pred] + beta_lan[lan_pred] + beta_rel[rel_pred]
			+ beta_emp[emp_pred] + beta_reg[reg_pred]
                        + beta_enp[enp_pred] + beta_dis[dis_pred] + beta_hea[hea_pred] + beta_yuk[yuk_pred]
                        + [beta_buk,-beta_buk][buk_pred]' + [beta_mig,-beta_mig][mig_pred]' + [beta_hhlan,-beta_hhlan][hhlan_pred]';
*/
vector[N_pred] lin_pred = beta_age[age_pred] + [beta_sex, -beta_sex][sex_pred]' + beta_edu[edu_pred] + beta_eth[eth_pred] + beta_lan[lan_pred] + beta_rel[rel_pred]
			+ beta_emp[emp_pred] + beta_reg[reg_pred]
                        + beta_dis[dis_pred] + beta_hea[hea_pred] + beta_yuk[yuk_pred]
                        + [beta_mig,-beta_mig][mig_pred]' + [beta_hhlan,-beta_hhlan][hhlan_pred]';
